...
2. **Aerei_Li_Linea**
    - Gli aerei con attributo _persone_max_ minimo X e comandati da piloti con età compresa fra 30 e 60 inclusi (10 volte al giorno)
...
[](https://docs.google.com/document/d/1nhvOKPnkAEypN998Kzv5q8iw8WVj2o3czqGw2cCtgTw/edit?usp=sharing)
...
|:------------------:|:---:|:------:|:------:|:--------:|
| **codice_fiscale** | PK  | STRING | UNIQUE | NOT NULL |
...
|                   | key |  type  | unique |   null   |
|:-----------------:|:---:|:------:|:------:|:--------:|
| **id_equipaggio** | PK  | STRING | UNIQUE | NOT NULL |
...
|              | key |  type  | unique |   null   |
|:------------:|:---:|:------:|:------:|:--------:|
| **id_aereo** | PK  | STRING | UNIQUE | NOT NULL |
...
|                          | key |  type  | unique |   null   |
|:------------------------:|:---:|:------:|:------:|:--------:|
|     **nome_modello**     | PK  | STRING | UNIQUE | NOT NULL |
| **azienda_costruttrice** | PK  | STRING | UNIQUE | NOT NULL |
...
#### 3.3.3 Vincoli d'integrità di EQUIPAGGIO
...
#### 3.3.2 Diagramma dei vincoli d'integrità referenziale
...
Per instaurare una connessione con una base di dati in R è necessario abbiamo utilizzato il comando `dbConnect()` in cui bisogna specificare il driver utilizzato e i principali parametri quali nome della base di dati, utente password, host e porta. 
...
La funzione custom `steward_aerei_pesanti` implementata in sql restituisce il numero di steward che sono imbarcati su voli serviti da aerei con peso all'interno di un certo range.
